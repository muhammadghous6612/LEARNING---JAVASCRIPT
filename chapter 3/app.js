...
// var number=prompt('EVEN/ODD NUMBER CHECKER')
// if(number%3){document.write('<h3 class="text-value">Its ODD NUMBER</h3>');}else{document.write('<h3 class="text-values">Its EVEN NUMBER</h3>')}